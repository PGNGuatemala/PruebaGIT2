<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="PruebaGIT2.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="PruebaGIT2" %>
